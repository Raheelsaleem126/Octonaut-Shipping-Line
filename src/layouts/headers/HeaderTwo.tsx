...
import logo_1 from "@/assets/img/logo/PNG A(1).png"
import logo_2 from "@/assets/img/logo/PNG B(1).png"
                        ...
                        <div className="tgmenu__action tgmenu__action-three d-none d-md-flex">
                           <ul className="list-wrap">
                              ...
                              <li className="header-btn">
                                 <Link href="/contact" className="btn btn-three">Tracking <InjectableSvg src="/assets/img/icon/right_arrow.svg" alt="" className="injectable" /></Link>
                              </li>
                           </ul>
                        </div>
